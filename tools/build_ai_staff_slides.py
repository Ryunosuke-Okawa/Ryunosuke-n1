...
""")
    ...
    def s02_premise(self):
        ...
        self._block(s, 12.0, 7.1, 1.1, 0.3, "2 / 14", 11, color=C['gray'], align=PP_ALIGN.RIGHT)
...
""")
    ...
    def s05_concept(self):
        ...
        for i, f in enumerate(funcs):
            x = 0.5 + i*(cw + gap)
            self._block(s, x, 2.7, cw, 2.5, f, 32, bold=True,
                        color=C['white'], bg=C['kawaru'], rounded=True,
                        align=PP_ALIGN.CENTER, anchor=MSO_ANCHOR.MIDDLE)

        # 下メッセージ
        self._block(s, 0.5, 5.7, 12.33, 1.1,
                    'この 5人 を作って、Kawaru事業部を動かす',
                    28, bold=True, color=C['kawaru'],
                    align=PP_ALIGN.CENTER, anchor=MSO_ANCHOR.MIDDLE,
                    bg=C['kawaru_l'], rounded=True)

        self._notes(s, """【私はこう考えた・15秒】
9月末までにAI社員5人を作るために、私はこう考えました。
事業に必要な機能を5つに分けて、5人のAI社員に分担してもらう。
マーケ、営業、デリバリー、事務・法務、戦略。
この5人を作って、Kawaru事業部を動かす。
""")
...
""")
    ...
    def s10_to_results(self):
        ...
        self._block(s, 12.0, 7.1, 1.1, 0.3, "10 / 14", 11, color=C['gray'], align=PP_ALIGN.RIGHT)
...
""")
    ...
    def s11_results(self):
        s = self._slide()
        self._bg(s)
        self._title(s, '半期 ¥6,710,000、4案件すべてにAI社員が動いている', 11)
...
""")
    ...
    def s12_now_future(self):
        ...
        self._block(s, 0.5, 6.0, 12.33, 0.6,
                    ...
                    align=PP_ALIGN.CENTER, anchor=MSO_ANCHOR.MIDDLE)
        self._block(s, 12.0, 7.1, 1.1, 0.3, "12 / 14", 11,
                    color=C['gray'], align=PP_ALIGN.RIGHT)
...
""")
    ...
    def s14_close(self):
        ...
        self._block(s, 10.1, 6.0, 2.4, 0.8, 'Kawaru BPO', 14, bold=True,
                    ...
                    align=PP_ALIGN.CENTER, anchor=MSO_ANCHOR.MIDDLE)
        self._block(s, 12.0, 7.1, 1.1, 0.3, '14 / 14', 11,
                    color=C['gray'], align=PP_ALIGN.RIGHT)
